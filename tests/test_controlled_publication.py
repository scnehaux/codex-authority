...
class ControlledPublicationTests(unittest.TestCase):
    ...
    def test_checked_in_config_is_exact_pr32_manual_release_activation(self):
        ...
        self.assertEqual(a["authority_service_source_revision"], "fe8c93c3ec9b9ee99ac9f524d20fe7d629538821")
        self.assertEqual(a["publisher_source_revision"], "fe8c93c3ec9b9ee99ac9f524d20fe7d629538821")
        self.assertEqual(a["permit_digest"], "8e16cbe86a556d3f484b45201731e2772ad58db948455e2f0a0cc9a3ad573cc8")
        self.assertEqual(a["evidence_sha256"], "44f7fef0b443012ea755c296a3692e3ad0f149b53ad6d41bd69e39e6def78c64")
        self.assertEqual(a["receipt_sha256"], "e9bf6ea534a509c0a1b004cedd22929d754f9d7763bdee40571e7ce82eeb8383")
